...
using Pairer = ad_planner::ExactStampPairer<std::string, int>;
...
TEST(ExactStampPairer, BoundsPendingMessagesByArrivalOrder)
{
  Pairer pairer(2U);
...
TEST(ExactStampPairer, ClearsPendingMessagesAcrossAResetEpoch)
{
  Pairer pairer(3U);
